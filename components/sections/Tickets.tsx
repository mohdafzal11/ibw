      ...
      <div className="container-lg">
        <div className="mainTitle text-center">
          ...
          <div className="outerBorder" style={{ display: 'flex', justifyContent: 'center' }}>
            <img src="/assets/images/2025/border-bottom.svg" alt="img" style={{ maxWidth: '100%' }} />
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="col-lg-4 col-md-6">
            <div className="cardTheme">
              <div className="cardHeader" style={{ background: 'linear-gradient(285.92deg, #0d0d0d -10.88%, #171717 100.58%, #111111 139.64%)' }}>
                <h4 className="title">General Pass</h4>
                <h4 className="smallText">INR 3,821</h4>
              </div>
              <div className="ticket__divider" style={{ background: 'linear-gradient(285.92deg, #0d0d0d -10.88%, #171717 100.58%, #111111 139.64%)' }}>
                <div className="ticket__notch ticket__notch--left"></div>
                <div className="ticket__notch ticket__notch--right"></div>
              </div>
              <div className="cardBody" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: 'linear-gradient(285.92deg, #0d0d0d -10.88%, #171717 100.58%, #111111 139.64%)' }}>
                <ul className="list">
